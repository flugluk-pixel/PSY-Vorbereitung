  ...
  const dashboardSectionDefs = [
    {
      ...
      cards: [
        ...
        { moduleId: 'operatorcheck', kicker: 'Operationen erkennen', title: 'Operatoren-Check', copy: 'Erkenne aus einer Gleichung, ob Plus, Minus, Mal oder Geteilt die richtige Rechenart ist.' },
